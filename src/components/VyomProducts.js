...
const API= "https://nimittech.com/manglaApi/vyom.php";
...
const VyomProduct = () => {
  ...
  const cover_demo = vyom[0]?.desc2.map((item) => {
    return {
      ...item,
    };
  });
                ...
                <div className="addItem-slider bg-gray-50 p-2 rounded-md mx-1">
                  ...
                  <div className="flex w-full">
                    <div className="w-full">
                      <NavLink
                        to="/cart" onClick={() => addToCart(curElem.id, curElem.image, curElem.desc1)}
