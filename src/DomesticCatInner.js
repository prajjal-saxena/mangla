...
import CoverImg from './images/domestic/category/cover.png'

const DomesticCatInner = () => {
  const {domestic} = useProductContext();
  const coverDomes = domestic[0]?.desc2;
    ...
    <div className="row">
        {
            domestic.map((curElem)=>(
                <>
                   <div key={curElem.id} className='col-3 my-2'>
                           ...
                           <div className="flip-card">
                                 <div className="flip-card-inner">
                                    <div className="flip-card-front">
                                       <img src={curElem.image} alt="Avatar" style={{width:"300px",height:"250px"}}/>
                                    </div>
...
`;
export default DomesticCatInner